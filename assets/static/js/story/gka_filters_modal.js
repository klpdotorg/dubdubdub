(function() {
    ...
    var onOpen = function() {
        ...
        $select_block.on("change", function(selected) {
            ...
            $search_button.attr('href', '/gka/#searchmodal?admin2='+selected.val+'&admin1='+$select_district.val());
        ...
        $select_cluster.on("change", function(selected) {
            ...
            $search_button.attr('href', '/gka/#searchmodal?admin3='+selected.val+'&admin1='+$select_district.val());
        ...
        $select_school.on("change", function(selected) {
            ...
            $('.btn-modal-close').click();
            $search_button.attr('href', '/gka/#searchmodal?school_id=' + selected.val + '&school_type=Primary School'+'&admin1='+$select_district.val());
