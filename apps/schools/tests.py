...
class ApiTestCase(unittest.TestCase):
    ...
    def test_api_schools_info(self):
        ...
        self.assertEqual(len(results['features']), 50, "got 50 schools as first page")
        sample_school = results['features'][0]
        self.assertTrue(sample_school['properties'].has_key('mgmt'), 'has a property called management')
        self.assertTrue(sample_school['properties'].has_key('cat'), 'has a property called category')
        self.assertTrue(sample_school['properties'].has_key('address_full'), 'has a property called address')
