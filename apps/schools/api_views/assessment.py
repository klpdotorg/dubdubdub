import sys
from schools.models import (Assessment, InstitutionAssessmentCohorts,
...
from schools.serializers import (AssessmentListSerializer, AssessmentInfoSerializer,
                                 ProgrammeListSerializer, ProgrammeInfoSerializer,
                                 BoundaryAssessmentInfoSerializer, BoundaryProgrammeInfoSerializer,
                                 ProgrammePercentileSerializer, BoundaryProgrammePercentileSerializer)
...
class AssessmentInfo(KLPListAPIView):
    ...
    def get_queryset(self):
        ...
        if self.request.GET.get('school', ''):
            sid = self.request.GET.get('school')
            assessmentinfo = InstitutionAssessmentSinglescore.objects.filter(
                school=sid, assessment=assid, studentgroup=studentgroup)\
