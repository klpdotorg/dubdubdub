...
urlpatterns = patterns('',
    ...
    url('^user/login$', 'users.api_views.login', name='api_user_login'),
    url('^user/logout$', 'users.api_views.logout', name='api_user_logout'),
    ...
    url('^organization/(?P<org_pk>[0-9]+)/users$',
